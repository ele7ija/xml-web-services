...
public class Zahtev {
    ...
    @XmlElement(name = "Trazilac", namespace = "http://ftn.uns.ac.rs/tim5/zahtev", required = true)
    protected TFizickoLice trazilac;
    @XmlElement(name = "Organ", namespace = "http://ftn.uns.ac.rs/tim5/zahtev", required = true)
    protected TPravnoLice organ;
    @XmlElement(name = "Pravni_Osnov", namespace = "http://ftn.uns.ac.rs/tim5/zahtev")
    ...
    @XmlElement(name = "Datum", namespace = "http://ftn.uns.ac.rs/tim5/zahtev", required = true)
    ...
    public static class ElementiZahteva {
        ...
        @XmlElement(name = "Element_Zahteva", namespace = "http://ftn.uns.ac.rs/tim5/zahtev", required = true)
