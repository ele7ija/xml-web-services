    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <p class="normal-text" style="margin-top: -102pt; margin-bottom: 0pt padding-bottom: 0pt; text-align: left;">
                    <xsl:value-of select="concat(' ', /zo:Zalba_na_odluku/zo:mesto_zalbe)" />
                </p>
                <p class="small-text" style="padding-top: 0pt; margin-top: 0pt; margin-bottom: 0pt; text-align: left;">
                    место
                </p>
