...
public class ZalbaOdlukaService extends Service {
    ...
    public rs.ac.uns.ftn.tim5.SOAP.zalbaOdluka.ZalbaOdlukaPort getZalbaCutanjePort() {
        return super.getPort(ZalbaPort, rs.ac.uns.ftn.tim5.SOAP.zalbaOdluka.ZalbaOdlukaPort.class);
    }
