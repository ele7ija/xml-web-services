...
@XmlSeeAlso({
    rs.ac.uns.ftn.tim5.model.izvestaj.Izvestaj.DatumPodnosenja.class,
    rs.ac.uns.ftn.tim5.model.resenje.Resenje.DatumResenja.class,
    rs.ac.uns.ftn.tim5.model.zalba_na_odluku.ZalbaNaOdluku.DatumZalbe.class,
    rs.ac.uns.ftn.tim5.model.zalba_cutanja.ZalbaCutanja.DatumZalbe.class
})
public class Datum {
