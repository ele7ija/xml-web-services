...
public class ApplicationUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(gradjanin == null){
            Poverenik sluzbenik = this.poverenikService.findByUsername(username);
            if(sluzbenik == null) {
                ...
                return new CustomUserDetails(
                        ...
                        new HashSet<>(Collections.singletonList(new SimpleGrantedAuthority(UserRole.POVERENIK.name()))),
                        UserRole.POVERENIK,
                        true
                );
            }
