...
package ftn.xmlws.tim5.apiorganvlasti.model.obavestenje;
...
public class Obavestenje {
    ...
    public static class Predmet {
        ...
        @XmlElement(name = "Odgovor", namespace = "http://ftn.uns.ac.rs/tim5/util", required = true)
        protected List<TOdgovorNaZahtev> odgovor;
        @XmlElement(name = "Uplata", namespace = "http://ftn.uns.ac.rs/tim5/util")
