...
<!--                        ubaciti adresu-->
                ...
                <div>
                    <p class="big-text" style="margin-top: 25pt;">
                ...
                <div>
                    ...
                    <table class="indented" style="margin-top: 10pt; font-size:10pt">
                        <thead>
                            <th>Број жалби на одлуку</th>
                            <th>Број жалби на ћутање (није поступио)</th>
                            <th>Број жалби на ћутање (није поступио у целости)</th>
                        </thead>
                        <tbody>
