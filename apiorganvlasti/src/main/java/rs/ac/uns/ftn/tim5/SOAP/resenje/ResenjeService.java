...
import rs.ac.uns.ftn.tim5.SOAP.zalbaOdluka.ZalbaOdlukaService;
...
public class ResenjeService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.sistem.org/ws/resenje", "ResenjeService");
    public final static QName ResenjePort = new QName("http://www.sistem.org/ws/resenje", "ResenjePort");
    static {
    ...
    public ResenjePort getResenjePort() {
        return super.getPort(ResenjePort, ResenjePort.class);
    }


    @WebEndpoint(name = "ResenjePort")
    public ResenjePort getResenjePort(WebServiceFeature... features) {
        return super.getPort(ResenjePort, ResenjePort.class, features);
    }
}
