<template>
  <div>
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark" v-if="role">
      <router-link to="/" class="navbar-brand" :style="{'margin-left': '10px'}">Portal poverenika</router-link>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark" v-if="!role">
      <h3 class="navbar-brand" :style="{'margin-left': '10px'}">Portal poverenika</h3>
