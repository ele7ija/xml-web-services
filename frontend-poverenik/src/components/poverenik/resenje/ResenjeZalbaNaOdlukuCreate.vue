...
import { constructZalbaNaOdluku, constructPoverenik } from '../../../util';
...
export default {
  ...
  async mounted() {
    if (sessionStorage.getItem('access_token')) {
      ...
      this.zalba = constructZalbaNaOdluku(Xonomy.xml2js((await zalbaNaOdlukuApi.getById(this.$route.params.idZalbe)).data));
      ...
      const xmlString = 
        ...
        <re:Resenje 
            ...
            <re:zalba>
                ...
                <re:Tip_zalbe>zalba_na_odluku</re:Tip_zalbe>
